...
nodes <- c(
  getMRCA(tree, tip = c("Colletes_gigas", "Osmia_lignaria")),
  ...
  getMRCA(tree, tip = c("Megachile_rotundata", "Melissodes_desponsus"))
)

age.min <- c(0, 53, 28, 60, 58, 104)
age.max <- c(179, 179, 179, 179, 179, 179)
