...
# note that I had to manually change the labels for the Eucera pruinosa population genomes
for FILE in *.txt; do
...
# Step 7: put all final alignments into a new folder and run iq-tree
mkdir -p tree 
...
#############################################################################################
## NB April 15th 2020: manually going through the trees made us realize that they needed to be rooted, 
## so I will add drosophila sequences into my mafft alignments and remake the trees
cp /home/avehi/Work/sensory_orthogroups_22DEC21/dmel/Dmel.OR.fasta .
